...
We advise users to run or update to the most recent release of the traffic_splitting. Older versions of the traffic_splitting may not have all enhancements and/or bug fixes applied to them.
